                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-12 col-lg-12 mb-5">
                        ...
                        <div class="card bg-primary shadow-soft border-light p-2 p-md-3 p-lg-5">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-12">
                                        <div class="shadow-inset p-4 mb-5 rounded">
                                            <iframe class="map rounded" id="gmap_canvas"src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3213.904046652821!2d127.39085411556368!3d36.33887530123037!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3565495ab673a925%3A0xe1188e07d40f345f!2z64yA7KCE6rSR7Jet7IucIOyEnOq1rCDtg4TrsKnrj5kg6rOE66Oh66GcIDYzNw!5e0!3m2!1sko!2skr!4v1637557225698!5m2!1sko!2skr"></iframe>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-8 text-center mb-5">
                                        <h1 class="display-3 mb-3">센터 오시는길</h1>
                                    </div>
                                </div>
                                <div class="row mb-5">
                                    <div class="col-md-4 col-lg-4 text-center">
                                        ...
                                        <div class="icon-box mb-4">
                                            ...
                                            <h2 class="h5 icon-box-title">위치</h2>
                                            <span>
                                                대전광역시 서구 계룡로 637
                                                <br>
                                                정일빌딩 7층, ISEC A/S
                                    ...
                                    <div class="col-md-4 col-lg-4 text-center">
                                        ...
                                        <div class="icon-box mb-4">
                                            ...
                                            <h2 class="h5 icon-box-title">대표전화</h2>
                                            <span>+1588-1234</span>
                                    ...
                                    <div class="col-md-4 col-lg-4 text-center">
                                        ...
                                        <div class="icon-box mb-4">
                                            ...
                                            <h2 class="h5 icon-box-title">전자우편</h2>
                            ...
                            <div class="alert alert-dark shadow-inset mt-4" role="alert">
                                <span class="alert-inner--icon icon-lg"><span class="far fa-bell"></span></span>
                                <span class="alert-heading">표준 운영시간</span>
                                <div class="col-md-12 row">
                                    <div class="col-md-6">
                                        <p class="mb-0">월 ~ 금(평일) : 09:00 ~ 19:00<br>혼잡시간대 : 월/금요일 09시 ~ 11시, 그외 : 12시 ~ 14시</p>
                                    </div>
                                    <div class="col-md-6">
                                        <p class="mb-0">토요일 : 09:00 ~ 13:00(일요일, 공휴일: 휴무)<br>혼잡시간대 : 토요일 10시 ~ 13시</p>
                                    </div>
                                </div>
                                <hr>
                                <div class="mb-2">
                                    <span class="fas fa-info-circle"> 센터 방문 전, 꼭 확인해주세요!</span>
                                </div>
                                <ul>
                                    <li>제품 점검 시간을 고려하여 운영시간 종료 최소 1시간 전까지 방문해 주세요.</li>
                                    <li>부품 구입을 위해 방문 시 모델명 확인 후 1588-1234으로 부품 예약을 해 주시면 재방문 하는 불편이 없습니다.</li>
                                    <li>휴대폰 엑세서리 서비스는 액세서리 구매 영수증 또는 해당 휴대폰을 반드시 지참해 주세요.</li>
                                    <li>평일은 제품 점검 시간을 고려하여 18시까지 방문을 부탁드립니다.</li>
                                    <li>토요일은 방문고객 혼잡도에 따라서 당일 수리 여부가 다를 수 있는 점 양해 부탁드립니다.</li>
                                </ul>
                            </div>
                        </div>
                        <!-- End of Contact Card -->
