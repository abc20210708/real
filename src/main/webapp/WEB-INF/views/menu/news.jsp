...
<body>
                ...
                <div class="navbar-collapse collapse" id="navbar_global">
                    ...
                    <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
                        <li class="nav-item dropdown">
                            <a href="/login/user" class="nav-link"  data-toggle="dropdown" >
    ...
    <main>
        <!-- Hero -->
        <section class="section section-header bg-primary pb-4">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-xl-8 text-center">
                        <h1 class="display-3 font-weight-light mb-4"><span class="font-weight-bold">카드뉴스</span>
                        </h1>
                        <p class="lead">가전 제품 관련한 팁과 주요 뉴스를 전해드립니다.</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row align-items-center">
                    <div class="col-12 col-md-6 col-lg-4 mb-5">
                        <div class="card bg-primary border-light shadow-soft">
                            <img src="/img/202010261518392680.webp" class="card-img-top rounded-top" alt="Themesberg office">
                            <div class="card-body">
                                <div class="media d-flex align-items-center justify-content-between">
                                    <div class="post-group">
                                        <a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="23k followers">
                                            <img class="avatar-sm mr-2 img-fluid rounded-circle" src="/img/italic(blue).png" alt="ISEC logo"> ISEC
                                        </a>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <span class="small"><span class="far fa-calendar-alt mr-2"></span>22 Nov 2021</span>
                                    </div>
                                </div> 
                                <h3 class="h5 card-title mt-3">가전제품 활용 - 6</h3>
                                <p class="card-text">ISEC에서 늘 새것처럼 걱정없이 관리할 수 있는 꿀팁을 소개해드려요.</p>
                                <a href="#" class="btn btn-primary btn-sm">카드뉴스확인</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4 mb-5">
                        <div class="card bg-primary border-light shadow-soft">
                            <img src="/img/201912121003011670.webp" class="card-img-top rounded-top" alt="Themesberg office">
                            <div class="card-body">
                                <div class="media d-flex align-items-center justify-content-between">
                                    <div class="post-group">
                                        <a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="23k followers">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <span class="small"><span class="far fa-calendar-alt mr-2"></span>17s Oct 2021</span>
                                    </div>
                                </div> 
                                <h3 class="h5 card-title mt-3">가전제품 활용 - 5</h3>
                                <p class="card-text">ISEC에서 늘 새것처럼 걱정없이 관리할 수 있는 꿀팁을 소개해드려요.</p>
                                <a href="#" class="btn btn-primary btn-sm">카드뉴스확인</a>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 mb-5">
                        <div class="card bg-primary border-light shadow-soft">
                            <img src="/img/201911281759072840.webp" class="card-img-top rounded-top" alt="Themesberg office">
                            <div class="card-body">
                                <div class="media d-flex align-items-center justify-content-between">
                                    <div class="post-group">
                                        <a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="23k followers">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <span class="small"><span class="far fa-calendar-alt mr-2"></span>15 Aug 2021</span>
                                    </div>
                                </div> 
                                <h3 class="h5 card-title mt-3">가전제품 활용 - 4</h3>
                                <p class="card-text">ISEC에서 늘 새것처럼 걱정없이 관리할 수 있는 꿀팁을 소개해드려요.</p>
                                <a href="#" class="btn btn-primary btn-sm">카드뉴스확인</a>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 mb-5">
                        <div class="card bg-primary border-light shadow-soft">
                            <img src="/img/201911281751060790.png" class="card-img-top rounded-top" alt="Themesberg office">
                            <div class="card-body">
                                <div class="media d-flex align-items-center justify-content-between">
                                    <div class="post-group">
                                        <a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="23k followers">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <span class="small"><span class="far fa-calendar-alt mr-2"></span>20 July 2021</span>
                                    </div>
                                </div> 
                                <h3 class="h5 card-title mt-3">가전제품 활용 - 3</h3>
                                <p class="card-text">ISEC에서 늘 새것처럼 걱정없이 관리할 수 있는 꿀팁을 소개해드려요.</p>
                                <a href="#" class="btn btn-primary btn-sm">카드뉴스확인</a>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 mb-5">
                        <div class="card bg-primary border-light shadow-soft">
                            <img src="/img/201911281746374200.webp" class="card-img-top rounded-top" alt="Themesberg office">
                            <div class="card-body">
                                <div class="media d-flex align-items-center justify-content-between">
                                    <div class="post-group">
                                        <a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="23k followers">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <span class="small"><span class="far fa-calendar-alt mr-2"></span>1 June 2021</span>
                                    </div>
                                </div> 
                                <h3 class="h5 card-title mt-3">가전제품 활용 - 2</h3>
                                <p class="card-text">ISEC에서 늘 새것처럼 걱정없이 관리할 수 있는 꿀팁을 소개해드려요.</p>
                                <a href="#" class="btn btn-primary btn-sm">카드뉴스확인</a>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 mb-5">
                        <div class="card bg-primary border-light shadow-soft">
                            <img src="/img/201909261712401850.webp" class="card-img-top rounded-top" alt="Themesberg office">
                            <div class="card-body">
                                <div class="media d-flex align-items-center justify-content-between">
                                    <div class="post-group">
                                        <a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="23k followers">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <span class="small"><span class="far fa-calendar-alt mr-2"></span>15 March 2021</span>
                                    </div>
                                </div> 
                                <h3 class="h5 card-title mt-3">가전제품 활용 - 1</h3>
                                <p class="card-text">ISEC에서 늘 새것처럼 걱정없이 관리할 수 있는 꿀팁을 소개해드려요.</p>
                                <a href="#" class="btn btn-primary btn-sm">카드뉴스확인</a>
                            </div>
                        </div>
