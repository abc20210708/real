                        ...
                        <div class="card bg-primary shadow-soft border-light p-4">
                            ...
                            <div class="card-body">
                                <form action="/user/modify" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-4">
                                            ...
                                            <input class="form-control" name="phone" id="exampleInputIcon4"
                                                value="${u.phone}" type="text" aria-label="email adress" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-4">
                                            ...
                                            <input class="form-control" id="exampleInputIcon4" name="address"
                                                value="${u.address}" type="text" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-4">
                                            ...
                                            <input class="form-control" id="exampleInputIcon4" name="postalCode"
                                                value="${u.postalCode}" type="text" disabled>
                                        </div>
                                    </div>
                                    <!-- End of Form -->
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-4">
                                                ...
                                                <input class="form-control" id="exampleInputPassword7" name="pw"
                                                    value="${u.pw}" type="password" aria-label="Password" disabled
                                                    required>
                                            </div>
                                        </div>
                                        <!-- End of Form -->
                                    ...
                                    <button type="button" id="modBtn" class="btn btn-block btn-primary">정보 수정</button>
                                </form>
                            </div>
                        </div>
                    </div>
